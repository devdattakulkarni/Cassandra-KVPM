...
public class CfDef implements org.apache.thrift.TBase<CfDef, CfDef._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.COLUMN_TYPE,_Fields.COMPARATOR_TYPE,_Fields.SUBCOMPARATOR_TYPE,_Fields.COMMENT,_Fields.ROW_CACHE_SIZE,_Fields.KEY_CACHE_SIZE,_Fields.READ_REPAIR_CHANCE,_Fields.COLUMN_METADATA,_Fields.GC_GRACE_SECONDS,_Fields.DEFAULT_VALIDATION_CLASS,_Fields.ID,_Fields.MIN_COMPACTION_THRESHOLD,_Fields.MAX_COMPACTION_THRESHOLD,_Fields.ROW_CACHE_SAVE_PERIOD_IN_SECONDS,_Fields.KEY_CACHE_SAVE_PERIOD_IN_SECONDS,_Fields.MEMTABLE_FLUSH_AFTER_MINS,_Fields.MEMTABLE_THROUGHPUT_IN_MB,_Fields.MEMTABLE_OPERATIONS_IN_MILLIONS,_Fields.REPLICATE_ON_WRITE,_Fields.MERGE_SHARDS_CHANCE,_Fields.KEY_VALIDATION_CLASS,_Fields.ROW_CACHE_PROVIDER,_Fields.KEY_ALIAS};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.column_metadata = new ArrayList<ColumnDef>(_list66.size);
                for (int _i67 = 0; _i67 < _list66.size; ++_i67)
                {
                  ColumnDef _elem68; // required
                  _elem68 = new ColumnDef();
                  _elem68.read(iprot);
                  struct.column_metadata.add(_elem68);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.column_metadata != null) {
        if (struct.isSetColumn_metadata()) {
          oprot.writeFieldBegin(COLUMN_METADATA_FIELD_DESC);
          {
            ...
            for (ColumnDef _iter69 : struct.column_metadata)
            {
              _iter69.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetColumn_metadata()) {
        {
          ...
          for (ColumnDef _iter70 : struct.column_metadata)
          {
            _iter70.write(oprot);
          }
        }
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.column_metadata = new ArrayList<ColumnDef>(_list71.size);
          for (int _i72 = 0; _i72 < _list71.size; ++_i72)
          {
            ColumnDef _elem73; // required
            _elem73 = new ColumnDef();
            _elem73.read(iprot);
            struct.column_metadata.add(_elem73);
          }
        }
        struct.setColumn_metadataIsSet(true);
      }
