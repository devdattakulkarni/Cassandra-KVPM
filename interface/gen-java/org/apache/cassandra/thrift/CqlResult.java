...
public class CqlResult implements org.apache.thrift.TBase<CqlResult, CqlResult._Fields>, java.io.Serializable, Cloneable {
  ...
  private _Fields optionals[] = {_Fields.ROWS,_Fields.NUM};
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.rows = new ArrayList<CqlRow>(_list100.size);
                for (int _i101 = 0; _i101 < _list100.size; ++_i101)
                {
                  CqlRow _elem102; // required
                  _elem102 = new CqlRow();
                  _elem102.read(iprot);
      ...
      if (struct.rows != null) {
        if (struct.isSetRows()) {
          oprot.writeFieldBegin(ROWS_FIELD_DESC);
          {
            ...
            for (CqlRow _iter103 : struct.rows)
            {
      ...
      if (struct.isSetRows()) {
        {
          ...
          for (CqlRow _iter104 : struct.rows)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.rows = new ArrayList<CqlRow>(_list105.size);
          for (int _i106 = 0; _i106 < _list105.size; ++_i106)
          {
            CqlRow _elem107; // required
            _elem107 = new CqlRow();
            _elem107.read(iprot);
